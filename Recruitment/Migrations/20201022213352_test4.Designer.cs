...
namespace Recruitment.Migrations
{
    ...
    [Migration("20201022213352_test4")]
    partial class test4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recruitment.Models.JobProfileDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("JobElementId");

                    b.Property<long>("JobProfileId");

                    b.Property<DateTime>("LastUpdated");

                    b.Property<string>("MaxRequirement");

                    b.Property<string>("MinRequirement");

                    b.HasKey("Id");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("JobElementId");

                    b.HasIndex("JobProfileId");

                    b.ToTable("JobProfileDetails");
                });
            ...
            modelBuilder.Entity("Recruitment.Models.JobProfileDetail", b =>
                {
                    ...
                    b.HasOne("Recruitment.Models.JobProfileElement", "JobProfileElement")
                        .WithMany()
                        .HasForeignKey("JobElementId")
                        .OnDelete(DeleteBehavior.Cascade);
